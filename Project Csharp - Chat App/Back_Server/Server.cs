...
namespace Back_Server
{
    public class Server
    {
        ...
        private int cptClientsLoggedIn;
        ...
        public void Start()
        {
            ...
            while (true)
            {
                ...
                receiver.When_Profile_Create += ProfileCreate;
        ...
        {
            CONSOLE.WriteLine(ConsoleColor.Magenta, "Number of clients Logged In / Number of clients Total : " + cptClientsLoggedIn + "/ " + receivers.Count);
        }
    }
}